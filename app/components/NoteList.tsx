...
const NoteList =() =>{
  return (
    <ul role="list" className="divide-y divide-gray-100  w-full p-4 flex gap-4 items-center grid">
      {people.map((person) => (
        <li key={person.email} className="gap-3 justify-between gap-x-6 py-5 p-4 b-b w-[50%] ">
